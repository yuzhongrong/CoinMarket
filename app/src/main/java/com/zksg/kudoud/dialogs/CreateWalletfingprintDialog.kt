...
class CreateWalletfingprintDialog(context: Activity,mWalletCreateFingPrintCallback: WalletCreateFingPrintCallback) : CenterPopupView(context) {

    private var mcontext=context
    private var eyeshow=false
    private var mWalletCreateFingPrintCallback=mWalletCreateFingPrintCallback
...
//        bt_confirm_pwd.setOnClickListener { this.delayDismiss(500) }
        ...
        Reprint.authenticate(object : AuthenticationListener {
            ...
            override fun onSuccess(moduleTag: Int) {
                ...
                mWalletCreateFingPrintCallback.walletCreateComplete(moduleTag)
                dismiss()
            }
            ...
            override fun onFailure(
                ...
                mWalletCreateFingPrintCallback.walletCreateFingPrintFail(errorCode)
