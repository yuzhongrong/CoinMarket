...
import com.zksg.kudoud.adapters.MemePumpinalmostapter
import com.zksg.kudoud.state.MemeCategoryCommonFragmentViewModel

class MemeCategoryPumpInAlmostFragment : BaseFragment() {
    ...
    companion object {
        fun newInstance(category: String): MemeCategoryPumpInAlmostFragment {
            val fragment = MemeCategoryPumpInAlmostFragment()
            val args = Bundle()
    ...
    override fun getDataBindingConfig(): DataBindingConfig {
        return DataBindingConfig(R.layout.list_meme_coins, BR.vm, mCategoryCommonFragmentViewModel!!)
               .addBindingParam(BR.adapter, MemePumpinalmostapter(context))
    }
