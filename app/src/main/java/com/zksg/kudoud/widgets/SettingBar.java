...
public final class SettingBar extends FrameLayout {
    ...
    public SettingBar(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mLeftView.setLineSpacing(getResources().getDimension(R.dimen.dp5), mLeftView.getLineSpacingMultiplier());
        mRightView.setLineSpacing(getResources().getDimension(R.dimen.dp5), mRightView.getLineSpacingMultiplier());

        mLeftView.setPaddingRelative((int) getResources().getDimension(R.dimen.dp15),
                (int) getResources().getDimension(R.dimen.dp12),
                (int) getResources().getDimension(R.dimen.dp15),
                (int) getResources().getDimension(R.dimen.dp12));
        mRightView.setPaddingRelative((int) getResources().getDimension(R.dimen.dp15),
                (int) getResources().getDimension(R.dimen.dp12),
                (int) getResources().getDimension(R.dimen.dp15),
                (int) getResources().getDimension(R.dimen.dp12));
        ...
        // 文字大小设置
        setLeftTextSize(TypedValue.COMPLEX_UNIT_PX, array.getDimensionPixelSize(R.styleable.SettingBar_bar_leftTextSize, (int) getResources().getDimension(R.dimen.sp15)));
        setRightTextSize(TypedValue.COMPLEX_UNIT_PX, array.getDimensionPixelSize(R.styleable.SettingBar_bar_rightTextSize, (int) getResources().getDimension(R.dimen.sp14)));
...
//            drawable.addState(new int[]{android.R.attr.state_pressed}, new ColorDrawable(ContextCompat.getColor(getContext(), com.zksg.base.R.color.black5)));
//            drawable.addState(new int[]{android.R.attr.state_selected}, new ColorDrawable(ContextCompat.getColor(getContext(), com.zksg.base.R.color.black5)));
//            drawable.addState(new int[]{android.R.attr.state_focused}, new ColorDrawable(ContextCompat.getColor(getContext(), com.zksg.base.R.color.black5)));
//            drawable.addState(new int[]{}, new ColorDrawable(ContextCompat.getColor(getContext(), com.zksg.base.R.color.white)));
