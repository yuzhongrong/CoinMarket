...
public class CircularProgressBar extends View {
    ...
    public CircularProgressBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mTextColor = array.getColor(R.styleable.CircularProgressBar_p_textColor, ContextCompat.getColor(context, R.color.black));
        mTextSize = array.getDimensionPixelSize(R.styleable.CircularProgressBar_p_textSize, (int) TypedValue
