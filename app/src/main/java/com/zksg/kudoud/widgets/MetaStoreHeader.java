...
public class MetaStoreHeader extends LinearLayout implements RefreshHeader {

    private View root;
    private AVLoadingIndicatorView mAVLoadingIndicatorView;
    public MetaStoreHeader(Context context) {
        super(context);
        initView(context);
    }
    public MetaStoreHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initView(context);
    }
    public MetaStoreHeader(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context) {
        ...
        setMinimumHeight(SmartUtil.dp2px(0));
    }
