...
public class CategoryAdapter_V extends BaseQuickAdapter<HomeItem, BaseViewHolder> {

    public CategoryAdapter_V(int layoutResId) {
        super(layoutResId);
    }


    public CategoryAdapter_V(int layoutResId, @Nullable List<HomeItem> data) {
...
//    }
    ...
    protected void convert(@NonNull BaseViewHolder baseViewHolder, HomeItem homeItems) {
        ...
        baseViewHolder.setText(R.id.desctiption,homeItems.getTitle());
